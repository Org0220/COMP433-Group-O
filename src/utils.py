...
def set_seed(seed, deterministic=True):
    ...
    print(f"Torch manual seed set to: {seed}")
    torch.cuda.manual_seed(seed)
    print(f"Torch CUDA manual seed set to: {seed}")
    torch.cuda.manual_seed_all(seed)
    print(f"Torch CUDA manual seed all set to: {seed}")
    ...
    if deterministic:
        try:
            ...
            print("CUDNN set to deterministic.")
